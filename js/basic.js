...
function updategroup(vall,gid){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "user/update_group/"+gid,
...
function updatecategory(vall,cid){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "qbank/update_category/"+cid,
		success: function(data){
		$("#message").html(data);
...
function updatecategory1(vall,cid){
	 
	var formData = {class_id:vall};

	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "qbank/update_category1/"+cid,
		success: function(data){
		$("#message").html(data);
...
function updateclass(vall,cid){
	 
	var formData = {class_name:vall};
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "qbank/update_class/"+cid,
		success: function(data){
		$("#message").html(data);
...
function updateclasssection(vall,cid){
	 
	var formData = {section_name:vall};
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "qbank/update_class_section/"+cid,
		success: function(data){
		$("#message").html(data);
...
function getexpiry(){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "user/get_expiry/"+gid,
		success: function(data){
...
function updatelevel(vall,lid){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "qbank/update_level/"+lid,
		success: function(data){
		$("#message").html(data);
...
function addquestion(quid,qid){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "quiz/add_qid/"+quid+'/'+qid,
		success: function(data){
...
function setIndividual_time(cqn){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "quiz/set_ind_time",
		success: function(data){
...
function assign_score(rid,qno,score){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "quiz/assign_score/"+rid+'/'+qno+'/'+score,
		success: function(data){
...
function update_fees_category(vall,gid){
	
	var formData = {group_name:vall};
	$.ajax({
		 type: "POST",
		 data : formData,
		 url: base_url+"accounting/edit_fees/"+gid,
		 success: function(data){
			$("#message").html(data);
		 },
		 error: function(xhr,status,strErr){
