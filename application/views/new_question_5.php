...
<h3><a href="<?=base_url()?>qbank">Question Bank</a> &raquo;<?php echo $title;?></h3>
        ...
        Select Subject
			...
			<div class="form-group">	 
					...
					<textarea  name="question"  class="form-control" style="height: 400px; ">
                    <table width="100%" cellpadding="0" cellspacing="2" border="0" style="font-size: 13px; border: none">
                    	<tr><td colspan="2" style="border: none">Please enter question story here(উদ্দীপক)</td></tr>
                        <tr><td style="border: none">ক) ......................</td><td width="1%" style="border: none" valign="bottom">১</td></tr>
                        <tr><td style="border: none">খ) ......................</td><td width="1%" style="border: none" valign="bottom">২</td></tr>
                        <tr><td style="border: none">গ) ......................</td><td width="1%" style="border: none" valign="bottom">৩</td></tr>
                        <tr><td style="border: none">ঘ) ......................</td><td width="1%" style="border: none" valign="bottom">৪</td></tr>
                    </table>
                    </textarea>
			</div>
			<div class="form-group">	 
